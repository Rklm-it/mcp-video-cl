...
- **Живое видео в сцене:** `animate=true` превращает картинку сцены в короткий ролик Veo 3.1
  (`REELS_VIDEO=veo`, платно за секунду). Лимит на ролик — `REELS_MAX_ANIMATED`. Если генерация
  не удалась, сцена остаётся картинкой, а ролик всё равно собирается.
